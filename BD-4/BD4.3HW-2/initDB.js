...
const db = new sqlite3.Database("./BD4.3HW-2/database.sqlite", (err) => {
  if (err) {
...
db.serialize(() => {
  ...
  // Insert random recipes data
  const stmt = db.prepare(
    "INSERT INTO recipes (name, cuisine, main_ingredient, preparation_time, difficulty, vegetarian) VALUES (?, ?, ?, ?, ?, ?)",
  );
